...
def main():
    ...
    print("native btc",transparent_delay_redeem_router.NATIVE_BTC())
    print("redeemStartedTimestamp",transparent_delay_redeem_router.redeemStartedTimestamp())
    print("redeemDelayTimestamp",transparent_delay_redeem_router.redeemDelayTimestamp())
    print("redeemPrincipalDelayTimestamp",transparent_delay_redeem_router.redeemPrincipalDelayTimestamp())
    validTimestamp = 2 * 604800;   
    transparent_delay_redeem_router.setRedeemPrincipalDelayTimestamp(validTimestamp,{'from': owner})
    print("redeemPrincipalDelayTimestamp",transparent_delay_redeem_router.redeemPrincipalDelayTimestamp())