...
# `brownie run scripts/zeta-mainnet/deploy.py main "deployer" "owner" --network=zeta-mainnet -I`
...
def main(deployer="deployer", owner="owner"):
    ...
    # Set zBTC cap
    zbtc = "0x13A0c5930C028511Dc02665E7285134B6d11A5f4"
    cap = 5000 * 1e8
    vault_transparent.setCap(zbtc, cap, {'from':owner})
    assert vault_transparent.caps(zbtc) == cap
