...
# `brownie run scripts/mode-mainnet/deploy.py main "uniBTCMainnetDeployer" "uniBTCMainnetAdmin" --network=mode-main -I`
...
def main(deployer="deployer", owner="owner"):
    ...
    cap = 5000 * 1e18
    vault_transparent.setCap(mbtc, cap, {'from':owner})
    assert vault_transparent.caps(mbtc) == cap
